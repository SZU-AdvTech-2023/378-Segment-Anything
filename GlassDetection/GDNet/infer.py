...
ckpt_path = 'E:\\00_Code\\PyCharmProjects\\UrbanSceneNet\\GlassDetection\\GDNet\\checkpoints'
exp_name = 'GDNet'
args = {
    'snapshot': '200',
    'scale': 416,
...
def main():
    ...
    if len(args['snapshot']) > 0:
        ...
        net.load_state_dict(
            torch.load("E:/00_Code/PyCharmProjects/UrbanSceneNet/GlassDetection/GDNet/checkpoints/200.pth"))
    ...
    with torch.no_grad():
        for name, root in to_test.items():
            ...
            for idx, img_name in enumerate(img_list):
                ...
                #                                       img_name[:-4] + "_l.png"))
                Image.fromarray(f3).save(
                    'E:/00_Code/PyCharmProjects/UrbanSceneNet/Results/galss_detec_results/GDNet_results/GDNet_{:03d}.png'.format(
                        idx))
