...
Very simple, but useful, especially in debugging DataProcess structures.
...
def saferepr(object):
    """Version of repr() which can handle recursive DataProcess structures."""
