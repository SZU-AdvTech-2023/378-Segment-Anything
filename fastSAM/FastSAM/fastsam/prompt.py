...
class FastSAMPrompt:
    ...
    def fast_show_mask_gpu(
        ...
        # Select DataProcess according to the index. The index indicates which batch's DataProcess to choose at each position, converting the mask_image into a single batch form.
