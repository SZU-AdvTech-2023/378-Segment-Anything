...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', type=str,
                        default='E:/00_Code/PyCharmProjects/UrbanSceneNet/DataProcess/original_datas/for_SIRR',
                        help='the images root dir. Contains: (crop, transmission)')
    parser.add_argument('--model_dir', type=str,
                        default='E:/00_Code/PyCharmProjects/UrbanSceneNet/ReflectiveRemoval/Location-aware-SIRR/checkpoints',
                        help='the model dir')
    parser.add_argument('--save_dir', type=str,
                        default='E:/00_Code/PyCharmProjects/UrbanSceneNet/Results/SIRR_results',
                        help='the results saving dir')
    parser.add_argument('--name', type=str, default='example_01',
                        help='the name of experiment, where to save model')
    ...
    gt_available = False
    I_dir = os.path.join(opts.data_root, 'crop')
